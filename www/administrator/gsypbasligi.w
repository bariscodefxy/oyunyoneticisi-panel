...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>GSYP Başlığı » {<administrator/bilgiler/adminbaslik.w}</title>
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="gsypbasligi.w">GSYP Başlığı</a></li> <!-- Add class "current" to sub menu items also -->
...
<div class="notification success png_bg">
				...
				<div>
					GSYP Başlığı Başarıyla Kaydedildi.
				</div>
			</div>
}
...
<div class="notification information png_bg">
				<div>
					GSYP Başlığını Düzenleyebilirsiniz.</div>
			</div>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/w/www/administrator/bilgiler/adminbaslik.w:{P.content}}
Fisier Salvat !
{h.location:gsypbasligi.w?basari=kaydedildi}
:
<form action="gsypbasligi.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=1 cols=20>{<<{W.moddir}/addons/w/www/administrator/bilgiler/{adminbaslik.w}}</textarea>
