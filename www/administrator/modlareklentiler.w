...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Modlar & Eklentiler » {<administrator/bilgiler/adminbaslik.w}</title>
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="modlareklentiler.w">Modlar & Eklentiler</a></li>
					</ul>
				</li>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
																		...
																		{{G.basari=tummodlaracildi}?
<div class="notification success png_bg">
				<a href="#" class="close"><img src="tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					Tüm Modlar Başarıyla Açıldı.
				</div>
			</div>
}	

																		{{G.basari=tummodlarkapatildi}?
<div class="notification success png_bg">
				<a href="#" class="close"><img src="tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					Tüm Modlar Başarıyla Kapatıldı.
				</div>
			</div>
}	

																		{{G.basari=tumeklentilerlaracildi}?
<div class="notification success png_bg">
				<a href="#" class="close"><img src="tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					Tüm Eklentiler Başarıyla Açıldı.
				</div>
			</div>
}	

																		{{G.basari=tumeklentilerkapatildi}?
<div class="notification success png_bg">
				<a href="#" class="close"><img src="tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					Tüm Eklentiler Başarıyla Kapatıldı.
				</div>
			</div>
}																	
				...
				<div>
					Modları & Eklentileri Yönetebilirsiniz.
				</div>
			</div>						
		...
		<table width="266">
							...
							<thead>
								<tr>
								   <th width="71">Modlar &amp; Eklentiler</th>
								   <th width="153">&nbsp;</th>
								   <th width="4">&nbsp;</th>
								   <th width="4">&nbsp;</th>
								   <th width="4">&nbsp;</th>
							...
							<tbody>
								<tr>
									...
									<b>Tüm Modlar:</b></td>
									<td width="153">
									<a href="modlar/tummodlar_ac.w">
									<img border="0" src="tasarim/images/ac.png" width="30" height="26"></a>&nbsp;
									<a href="modlar/tummodlar_kapat.w">
									<img border="0" src="tasarim/images/kapat.png" width="49" height="26"></a></td>
									...
									<td width="4">&nbsp;</td>
																...
																<tr>
									<td width="71">
									<b>Tüm Eklentiler:</b></td>
									<td width="153">
									<a href="eklentiler/tumeklentiler_ac.w">
									<img border="0" src="tasarim/images/ac.png" width="30" height="26"></a>&nbsp;
									<a href="eklentiler/tumeklentiler_kapat.w">
