...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Sunucu Hesap Bilgisi » {<administrator/bilgiler/adminbaslik.w}</title>
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="sunucuhesapbilgisi.w">Sunucu Hesap Bilgisi</a></li> <!-- Add class "current" to sub menu items also -->
					</ul>
				</li>
...
<div class="notification attention png_bg">
							...
							<div>
{<administrator/bilgiler/sunucuip.w} IP Adresli <SCRIPT LANGUAGE="JavaScript">  
...
<div class="notification information png_bg">
				<div>
					Sunucu Aylık Ödeme Tarihini Değiştirebilirsiniz.Tarihi Ay Adı(İngilizce) Gün, Yıl Şeklinde Giriniz.(Örnek: January 01,2011)</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Sunucu Hesap Bilgisi</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/w/www/administrator/bilgiler/sunucuaylikodeme.w:{P.content}}
Fisier Salvat !
{h.location:sunucuhesapbilgisi.w?basari=degistirildi}
:
<form action="sunucuhesapbilgisi.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=1 cols=20>{<<{W.moddir}/addons/w/www/administrator/bilgiler/{sunucuaylikodeme.w}}</textarea>
