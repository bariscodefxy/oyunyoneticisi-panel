...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>İstekler & Yardım » {<administrator/bilgiler/baslik.w}</title>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					<a href="istekleryardim.w" class="nav-top-item no-submenu current"> <!-- Add the class "no-submenu" to menu items with no sub menu -->
						İstekler & Yardım
					</a>       
				</li>
...
<div class="notification information png_bg">
				<div>
					Sunucunuz İçin İsteklerinizi Bildirebilir, Yardım 
					İsteyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">İstekler &amp; Yardım</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.authed?
{P.content?
{>{W.moddir}/addons/w/www/administrator/istekleryardim/istekleryardim.ini:{P.content}}
Fisier Salvat !
{h.location:istekleryardim.w?basari=kaydedildi}
:
<form action="istekleryardim.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/w/www/administrator/istekleryardim/{istekleryardim.ini}}</textarea>
