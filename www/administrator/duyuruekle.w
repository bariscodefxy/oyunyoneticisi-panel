...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Duyuru Ekle » {<administrator/bilgiler/adminbaslik.w}</title>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<li>
				...
				<li> 
					...
					<ul>
						<li><a class=current href="duyuruekle.w">Duyuru Ekle</a></li>
...
<div class="notification success png_bg">
             ...
             {>>{W.moddir}/addons/w/www/administrator/bilgiler/duyuru.w:
{P.command}
}
...
<form action="duyuruekle.w" method="post" name="rconform">
		<table>
							...
							<tbody>
								<tr>
									...
									<b>Duyuru Ekle:</b></td>
									<td>
									<input class="text-input large-input" type="text" name="command" size="20"></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
