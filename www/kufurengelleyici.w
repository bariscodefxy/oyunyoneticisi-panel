...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Küfür Engelleyici » {<administrator/bilgiler/baslik.w}</title>
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current  href="eklentiler.w">Eklentiler</a></li> <!-- Add class "current" to sub menu items also -->
					</ul>
				</li>
...
<div class="notification information png_bg">
				<div>
					Sunucunuzdaki Görünmesini İstemediğiniz Küfürleri Düzenleyebilirsiniz. 
				</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Küfür Engelleyici</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.authed?
{P.content?
{>{W.moddir}/addons/amxmodx/configs/swear/swearwords.ini:{P.content}}
Fisier Salvat !
{h.location:kufurengelleyici.w?basari=kaydedildi}
:
<form action="kufurengelleyici.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/amxmodx/configs/swear/{swearwords.ini}}</textarea>
