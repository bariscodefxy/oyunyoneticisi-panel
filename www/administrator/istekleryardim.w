...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>İstekler & Yardım » {<administrator/bilgiler/adminbaslik.w}</title>
...
<div class="notification information png_bg">
				<div>
					Sunucu İçin Bildirilen İstekleri, İstenilen Yardımları 
					Yanıtlayabilirsiniz. 
</div>
			</div>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/w/www/administrator/istekleryardim/istekleryardim.cfg:{P.content}}
Fisier Salvat !
...
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/w/www/administrator/istekleryardim/{istekleryardim.cfg}}</textarea>
