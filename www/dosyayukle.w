...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Dosya Yükle » {<administrator/bilgiler/baslik.w}</title>
				...
				<li>
					<a class="nav-top-item"> <!-- Add the class "current" to current menu item -->
						Sunucu Dosyaları
                                                                                ...
                                                                                <ul>
						<li><a class=current href="amxxcfg.w">Amxx.cfg</a></li>
...
{{G.uyari=dosyaboyutufazla"}?
<div class="notification attention png_bg">
				<a href="#" class="close"><img src="administrator/tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					Dosya Boyutu 20 MB (MegaByet)'tan Fazla Olmamalıdır.
				</div>
			</div>
}

{{G.hata=dosyayuklenemedi}?
<div class="notification error png_bg">
				<a href="#" class="close"><img src="administrator/tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					Dosya Yüklenemedi.
...
<div class="notification information png_bg">
				<div>
					Sunucunuza Dosya Yükleyebilirsiniz.Maksimum Dosya Boyutu 20 
					MB (MegaByet)'tır.</div>
			</div>
			

	<form enctype="multipart/form-data" action="http://http://188.132.218.87/gskp.php" method="POST">											
						<table width="1030">
							
							<thead>
								<tr>
								   <th width="184">Dosya Yükle</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
...
<b>Dosyanın Yükleneceği Dizin:</b></td>
									<td>
<select name="dizin">
<option value="cstrike">Ana Dizin (/cstrike)</option>
<option value="cstrike/maps">Haritalar (/cstrike/maps)</option>
<option value="cstrike/sound">Sesler (/cstrike/sound)</option>
<option value="cstrike/models">Modeller (/cstrike/models)</option>
</select></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
...
<b>Ek Dizin:<br><small>Boş Bırakabilirsiniz.</small></b></td>
									<td>
									<input class="text-input large-input" type="text" name="ekdizin" /></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
...
&nbsp;</td>
									<td>
<input class=button type="submit" value="Yükle" /></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
