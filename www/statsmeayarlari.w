...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>StatsMe Ayarları » {<administrator/bilgiler/baslik.w}</title>
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					StatsMe</a><ul>
						<li><a class=current href="statsmeayarlari.w">StatsMe Ayarları</a></li>
...
<div class="notification success png_bg">
				...
				<div>
					StatsMe Sıfırlama Sınırı Başarıyla Değiştirildi.
				</div>
			</div>
}
...
<div class="notification information png_bg">
				<div>
					StatsMe Ayarlarınızı Düzenleyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="236">StatsMe Ayarları</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
...
<font color="#252525">{{c.sm_enabled!1}?:</font><font color="#008000"><b>AÇIK</b></font><font color="#252525"> }{{c.sm_enabled!0}?:</font><font color="#FF0000"><b>KAPALI</b>

</font>

<font color="#252525">}{{c.sm_enabled!}?:</font><font color="#808080"><b>YÜKLÜ 
DEĞİL</b></font><font color="#252525">}
</font>
								...
								<tr>
									<td width="236">
									<b>StatsMe Durumu Değiştir:</b></td>
									<td>
...
<a href="administrator/islemler/statsmekapat.w"><img border="0" src="administrator/tasarim/images/kapat.png" width="49" height="26"></a></td>
									...
									<td>&nbsp;</td>
																...
																<tr>
									<td width="236">
									<b>StatsMe Sıfırlama:</b></td>
									<td>
StatsMe Sıfırlamak İçin <a href="administrator/islemler/statsmesifirlama.w">Tıklayınız.</a><br><small>Bu İşlem Gerçekleştikten Sonra de_dust2 Haritası Açılacaktır.</small></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
																...
																<tr>
									<td width="236">
									<b>StatsMe Sıfırlama Sınırı:</b></td>
									<td>
{c.csstats_maxsize} Oyuncu</td>
									...
									<td>&nbsp;</td>
																...
																<tr>
									<td width="236">
									<b>StatsMe Sıfırlama Sınırı Değiştir:</b></td>
...
<input type="submit" value="Değiştir" class="button"></form></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
