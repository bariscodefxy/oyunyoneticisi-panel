...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Sunucu Ayarları » {<administrator/bilgiler/adminbaslik.w}</title>
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="sunucuayarlari.w">Sunucu Ayarları</a></li> <!-- Add class "current" to sub menu items also -->
...
<div class="notification information png_bg">
				<div>
					Sunucu Ayarlarını Düzenleyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Sunucu Ayarları</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.admin?
{P.content?
{>{W.moddir}/server.cfg:{P.content}}
Fisier Salvat !
{h.location:sunucuayarlari.w?basari=kaydedildi}
:
<form action="sunucuayarlari.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/{server.cfg}}</textarea>
