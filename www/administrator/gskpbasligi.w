...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>GSKP Başlığı » {<administrator/bilgiler/adminbaslik.w}</title>
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						<li><a class=current href="gskpbasligi.w">GSKP Başlığı</a></li>
...
<div class="notification success png_bg">
				...
				<div>
					GSKP Başlığı Başarıyla Kaydedildi.
				</div>
			</div>
}
...
<div class="notification information png_bg">
				<div>
					GSKP Başlığını Düzenleyebilirsiniz.</div>
			</div>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/w/www/administrator/bilgiler/baslik.w:{P.content}}
Fisier Salvat !
{h.location:gskpbasligi.w?basari=kaydedildi}
:
<form action="gskpbasligi.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=1 cols=20>{<<{W.moddir}/addons/w/www/administrator/bilgiler/{baslik.w}}</textarea>
