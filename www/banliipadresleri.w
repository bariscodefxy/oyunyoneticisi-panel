...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Banlı IP Adresleri » {<administrator/bilgiler/baslik.w}</title>
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="banliipadresleri.w">Banlı IP Adresleri</a></li>
...
<div class="notification information png_bg">
				<div>
					Sunucunuzda Banlanmış Oyuncuların IP Adreslerini Düzenleyebilirsiniz. 
				</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Banlı IP Adresleri</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
...
{P.content?
{>{W.moddir}/listip.cfg:asd}
Fisier Salvat !
{h.location:banliipadresleri.w?basari=kaydedildi}
:
<form action="banliipadresleri.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/{listip.cfg}}</textarea>
