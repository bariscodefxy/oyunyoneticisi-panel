...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Kuruluş Tarihi » {<administrator/bilgiler/adminbaslik.w}</title>
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="kurulustarihi.w">Kuruluş Tarihi</a></li>
...
<div class="notification success png_bg">
				...
				<div>
					Kuruluş Tarihi Başarıyla Kaydedildi.
				</div>
			</div>
}
...
<div class="notification information png_bg">
				<div>
					Hostinginizin Kuruluş Tarihini Girebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Kuruluş Tarihi</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/w/www/administrator/bilgiler/telifhaklari.w:{P.content}}
Fisier Salvat !
{h.location:kurulustarihi.w?basari=kaydedildi}
:
<form action="kurulustarihi.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=1 cols=20>{<<{W.moddir}/addons/w/www/administrator/bilgiler/{telifhaklari.w}}</textarea>
