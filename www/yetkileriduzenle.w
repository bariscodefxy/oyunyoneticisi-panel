			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					<a class="nav-top-item current"> <!-- Add the class "current" to current menu item -->
						...
						<li><a class=current href="yetkileriduzenle.w">Cmdaccess.ini</a></li>
...
<div class="notification information png_bg">
				<div>
					Sunucunuzdaki Admin Yetkilerini Düzenleyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Yetkileri Düzenle</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
...
<br>
						{v.authed?
{P.content?
{>{W.moddir}/addons/amxmodx/configs/cmdaccess.ini:{P.content}}
Fisier Salvat !
...
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/amxmodx/configs/{cmdaccess.ini}}</textarea>
