...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Otomatik Say Reklamı Ekle » {<administrator/bilgiler/baslik.w}</title>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
									...
									{{G.basari=otomatiksayreklamieklendi}?
<div class="notification success png_bg">
				...
				<div>
					Otomatik Say Reklamı Başarıyla Eklendi.
				</div>
			</div>
}
<div class="notification information png_bg">
				<div>
					Sunucunuza Say Reklamı Ekleyebilirsiniz.</div>
			</div>
			

<form action="administrator/islemler/otomatiksayreklamiekle.w" method="post" name="rconform">														
						<table width="1030">
							
							<thead>
								<tr>
								   <th width="206">Otomatik Say Reklamı Ekle</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
