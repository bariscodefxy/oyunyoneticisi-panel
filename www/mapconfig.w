...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Adminleri Listele » {<administrator/bilgiler/baslik.w}</title>
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a href="adminekle.w">Admin Ekle</a></li> 
				...
				<li>
					<a class="nav-top-item current"> <!-- Add the class "current" to current menu item -->
						...
						<li><a class=current href="mapconfig.w">Mapconfig</a></li>
					</ul>
				</li>
...
<div class="notification information png_bg">
				<div>
					Sunucunuzdaki Mod Pluginlerini Düzenleyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Mod Pluginleri Düzenle</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
...
<br>
						{v.authed?
{P.content?
{>{W.moddir}/addons/amxmodx/configs/mapconfig/plugins.ini:{P.content}}
Fisier Salvat !
{h.location:adminleriduzenle.w?basari=kaydedildi}
:
<form action="adminleriduzenle.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/amxmodx/configs/mapconfig/{plugins.ini}}</textarea>
