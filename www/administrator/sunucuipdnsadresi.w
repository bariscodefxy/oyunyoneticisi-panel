...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Sunucu IP & DNS Adresi » {<administrator/bilgiler/adminbaslik.w}</title>
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						<li><a class=current href="sunucuipdnsadresi.w">Sunucu IP & DNS Adresi</a></li>
...
<div class="notification success png_bg">
				...
				<div>
					Sunucu IP & DNS Adresi Başarıyla Kaydedildi.
				</div>
			</div>
}
...
<div class="notification information png_bg">
				<div>
					Sunucu IP &amp; DNS Adresi Girebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Sunucu IP &amp; DNS Adresi</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/w/www/administrator/bilgiler/sunucuip.w:{P.content}}
Fisier Salvat !
{h.location:sunucuipdnsadresi.w?basari=kaydedildi}
:
<form action="sunucuipdnsadresi.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=1 cols=20>{<<{W.moddir}/addons/w/www/administrator/bilgiler/{sunucuip.w}}</textarea>
