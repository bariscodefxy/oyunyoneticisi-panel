			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="duyurulariduzenle.w">Duyuruları Düzenle</a></li> <!-- Add class "current" to sub menu items also -->
					</ul>
				</li>
...
<div class="notification information png_bg">
				<div>
					Duyurularınızı Düzenleyebilirsiniz.. 
</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Duyuruları Düzenle</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/w/www/administrator/bilgiler/duyuru.w:{P.content}}
Fisier Salvat !
{h.location:duyurulariduzenle.w?basari=kaydedildi}
:
<form action="duyurulariduzenle.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/w/www/administrator/bilgiler/{duyuru.w}}</textarea>
