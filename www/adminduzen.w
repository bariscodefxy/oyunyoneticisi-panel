...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Adminleri Düzenle » {<administrator/bilgiler/baslik.w}</title>
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a href="adminleriduzenle.w.w">Adminleri Düzenle</a></li>
				...
				<li>
					<a class="nav-top-item current"> <!-- Add the class "current" to current menu item -->
						...
						<li><a class=current href="adminduzen.w">Users.ini</a></li>
...
<div class="notification information png_bg">
				<div>
					Sunucunuzdaki Adminleri Düzenleyebilirsiniz.
				</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Adminleri Düzenle </th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.authed?
{P.content?
{>{W.moddir}/addons/amxmodx/configs/users.ini:{P.content}}
Fisier Salvat !
...
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/amxmodx/configs/{users.ini}}</textarea>
