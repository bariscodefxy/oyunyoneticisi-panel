...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>GSYP Şifresi » {<administrator/bilgiler/adminbaslik.w}</title>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						<li><a class=current href="gsypsifresi.w">GSYP Şifresi</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div>
					GSYP Şifresi Anında Değişecektir.GSYP Güvenliğiniz İçin GSYP Şifreniz Harf ve Sayıdan Oluşmalıdır.
				</div>
			</div>						
				
<form action="islemler/gsypsifresi.w" method="post" name="rcon_hostform">	
		<table>
							...
							<tbody>
								<tr>
									...
									<b>GSYP Şifresi:</b></td>
									<td>
									<input class="text-input medium-input" type="text" name="command" value="{c.webmod_adminpass}" size="20"><br>
									<small>GSYP Şifrenizde karakter (?=/()&+%) ve boşluk bulunmamalıdır.</small></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								</tr>
