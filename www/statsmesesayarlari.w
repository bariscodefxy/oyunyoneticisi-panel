...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>StatsMe Ses Ayarları » {<administrator/bilgiler/baslik.w}</title>
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					StatsMe</a><ul>
						...
						<li><a class=current href="statsmesesayarlari.w">StatsMe Ses Ayarları<br>(Headshot & Multikill)</a></li> <!-- Add class "current" to sub menu items also -->
					</ul>
				</li>
...
<div class="notification success png_bg">
				...
				<div>
					StatsMe Sesleri Başarıyla Açıldı.
				</div>
			</div>
}

																		{{G.basari=statsmeseskapatildi}?
<div class="notification success png_bg">
				<a href="#" class="close"><img src="administrator/tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					StatsMe Sesleri Başarıyla Kapatıldı.
				</div>
			</div>
}

									
									{{G.basari=statsmeseserkek}?
<div class="notification success png_bg">
				<a href="#" class="close"><img src="administrator/tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					StatsMe Erkek Sesleri Başarıyla Açıldı.
				</div>
			</div>
}

									{{G.basari=statsmeseskadin}?
<div class="notification success png_bg">
				<a href="#" class="close"><img src="administrator/tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					StatsMe Kadın Sesleri Başarıyla Açıldı.
				</div>
			</div>
}
...
<div class="notification information png_bg">
				<div>
					StatsMe Ses Ayarlarınızı Düzenleyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="236">StatsMe Ses Ayarları<br>(Headshot & Multikill)</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
...
&nbsp;</td>
								...
								<tr>
									<td width="236">
									<b>StatsMe Sesleri Durumu Değiştir:</b></td>
									<td>
<a href="administrator/islemler/statsmesesac.w">
<img border="0" src="administrator/tasarim/images/ac.png" width="30" height="26"></a>&nbsp;
<a href="administrator/islemler/statsmeseskapat.w"><img border="0" src="administrator/tasarim/images/kapat.png" width="49" height="26"></a></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
																...
																<tr>
									<td width="236">
									<b>StatsMe Sesleri Türü:</b></td>
									<td>
<font color="#000000" size="2">
<a class=button href="administrator/islemler/statsmeerkekses.w">Erkek</a><font color="#000000">&nbsp;
</font><a class=button href="administrator/islemler/statsmekadinses.w">Kadın</a></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
