...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>StatsMe Ayarları » {<administrator/bilgiler/adminbaslik.w}</title>
...
<div class="notification information png_bg">
				<div>
					StatsMe Ayarlarını Düzenleyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">StatsMe Ayarları</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/statsme/statsme.cfg:{P.content}}
Fisier Salvat !
{h.location:statsmeayarlari.w?basari=kaydedildi}
:
<form action="statsmeayarlari.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/statsme/{statsme.cfg}}</textarea>
