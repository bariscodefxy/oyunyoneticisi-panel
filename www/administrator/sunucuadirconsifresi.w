...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Sunucu Adı & Rcon Şifresi » {<administrator/bilgiler/adminbaslik.w}</title>
...
<div class="notification success png_bg">
				...
				<div>
					Sunucu Adı &amp; Rcon Şifresi Başarıyla Değiştirildi.</div>
			</div>
}																	
																		
																		<div class="notification information png_bg">
				<div>
					Sunucu Adı &amp; Rcon Şifresi Anında Değişecektir.Sunucu Güvenliğiniz İçin 
					Rcon Şifreniz Harf ve Sayıdan Oluşmalıdır.
				</div>
			</div>						
				
<form action="islemler/adminsunucuadirconsifresi.w" method="post" name="rcon_hostform">						
						<table width="554">
