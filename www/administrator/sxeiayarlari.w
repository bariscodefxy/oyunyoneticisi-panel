...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>sXe Injected Ayarları » {<administrator/bilgiler/adminbaslik.w}</title>
...
<div class="notification success png_bg">
				...
				<div>
					sXe Injected Güncelleme Başarıyla Açıldı.
				</div>
			</div>
}
...
<div class="notification success png_bg">
				<a href="#" class="close"><img src="tasarim/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
				<div>
					sXe Injected Güncelleme Başarıyla Kapatıldı.
				</div>
			</div>
}
				...
				<div>
					sXe Injected Ayarlarını Yönetebilirsiniz.
				</div>
			</div>						
		...
		<table>
							...
							<tbody>
								<tr>
									...
									<td>
									{{c.__sxei_required!}?:<b><font color="gray">YÜKLÜ DEĞİL</font></b>}
 {{c.__sxei_required!-1}?:<b><font color="red">KAPALI</font></b>}
 {{c.__sxei_required!1}?:<font color="green"><b>AÇIK</b></font>}
 {{c.__sxei_required!0}?:<b><font color="darkorange">OPSİYONEL</font></b>}&nbsp;
									</td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									...
									<td>&nbsp;</td>
																								...
																								<tr>
									<td>
									<b>sXe Injected Güncelleme Durumu:</b></td>
									<td>
									{{c.__sxei_srv_upg!}?:<b><font color="gray">YÜKLÜ DEĞİL</font></b>} 
									{{c.__sxei_srv_upg!0}?:<b><font color="red">KAPALI</font></b>} 
									{{c.__sxei_srv_upg!1}?:<font color="green"><b>AÇIK</b></font>}
									</td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
																								...
																								<tr>
									<td>
									<b>sXe Injected Güncelleme:</b></td>
									<td>
