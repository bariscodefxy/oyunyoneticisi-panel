...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Tasarım & Kodlama » {<administrator/bilgiler/adminbaslik.w}</title>
			...
			<a href="#"><img id="logo" src="tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="tasarimkodlama.w">Tasarım & Kodlama</a></li>
...
<div class="notification success png_bg">
				...
				<div>
					Tasarım & Kodlama Başarıyla Kaydedildi.
				</div>
			</div>
}
...
<div class="notification information png_bg">
				<div>
					Tasarım & Kodlama Yapan Kişiyi Düzenleyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Tasarım &amp; Kodlama</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.admin?
{P.content?
{>{W.moddir}/addons/w/www/administrator/bilgiler/tasarimkodlama.w:{P.content}}
Fisier Salvat !
{h.location:tasarimkodlama.w?basari=kaydedildi}
:
<form action="tasarimkodlama.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=1 cols=20>{<<{W.moddir}/addons/w/www/administrator/bilgiler/{tasarimkodlama.w}}</textarea>
