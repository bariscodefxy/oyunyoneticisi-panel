...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Sunucu Yeniden Başlat » {<administrator/bilgiler/baslik.w}</title>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="sunucuyenidenbaslat.w">Sunucu Yeniden Başlat</a></li>
					</ul>
				</li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="notification attention png_bg">
				<div>
					Bu İşlem Sonucunda Tüm Oyuncular Sunucudan Atılacaktır.Bu 
					İşlem Yaklaşık 3 Saniye Sürecektir.Lütfen Sayfayı Kapatmayınız.</div>
			</div>

<div class="notification information png_bg">
				<div>
					Sunucunuzu Yeniden Başlatabilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="316">Sunucu Yeniden Başlat</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
							...
							<tbody>
								<tr>
									<td width="316">
									Sunucunuzu Yeniden Başlatmak İçin <a href="administrator/islemler/yenidenbaslat.w">
									Tıklayınız.</a></td>
									<td>&nbsp;</td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
