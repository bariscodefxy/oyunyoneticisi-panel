...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Sunucu Adı & Rcon Şifresi » {<administrator/bilgiler/baslik.w}</title>
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						<li><a class=current href="sunucuadirconsifresi.w">Sunucu Adı & Rcon Şifresi</a></li>
...
<div class="notification success png_bg">
				...
				<div>
					Sunucu Adı Başarıyla Değiştirildi.</div>
			</div>
}
			...
			<div class="notification attention png_bg">
				<div>
					Sunucu Adınızda İzinsiz Herhangi Bir IP Adresi, E-Posta Adresi, Web Sitesi... Gibi Reklamlar Yasaktır.Sunucunuz Koşulsuz Kapatılır, Geri İade Yapılmaz.
				</div>
			</div>
			
						<div class="notification information png_bg">
				<div>
					Sunucu Adı & Rcon Şifresi Anında Değişecektir.Sunucu 
					Güvenliğiniz İçin Rcon Şifreniz Harf ve Sayıdan Oluşmalıdır.
				</div>
			</div>
			
						<form action="administrator/islemler/sunucuadirconsifresi.w" method="post" name="rcon_hostform">						
						<table width="554">
							
							<thead>
								<tr>
								   <th width="125">Sunucu Adı &amp; Rcon Şifresi</th>
								   <th width="387">&nbsp;</th>
								   <th width="4">&nbsp;</th>
								   <th width="4">&nbsp;</th>
								   <th width="4">&nbsp;</th>
							...
							<tbody>
								<tr>
									...
									<b>Sunucu Adı:</b></td>
									<td width="387">
									<input class="text-input medium-input" type="text" name="command" value="{c.hostname}" size="20"></td>
									<td width="4">&nbsp;<td width="4">&nbsp;</td>
									<td width="4">&nbsp;</td>
									<td width="4">&nbsp;</td>
								</tr>
									...
									<b>Rcon Şifresi:</b></td>
									<td width="387">
									<input class="text-input medium-input" type="text" name="command2" value="{c.rcon_password}" size="20"><br><small>Rcon Şifrenizde karakter (?=/()&+%) ve boşluk bulunmamalıdır.</small></td>
									<td width="4">&nbsp;<td width="4">&nbsp;</td>
									<td width="4">&nbsp;</td>
									<td width="4">&nbsp;</td>
								</tr>
									...
									&nbsp;</td>
									<td width="387">
									<input class=button type="submit" value="Uygula"></td>
									<td width="4">&nbsp;<td width="4">&nbsp;</td>
									<td width="4">&nbsp;</td>
									<td width="4">&nbsp;</td>
								</tr>
