...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Sunucu Giriş Ekranı » {<administrator/bilgiler/baslik.w}</title>
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="sunucugirisekrani.w">Sunucu Giriş Ekranı</a></li> <!-- Add class "current" to sub menu items also -->
...
<div class="notification information png_bg">
				<div>
					Sunucunuza Girerken Gelen Ekrandaki Yazıları Düzenleyebilirsiniz. 
				</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Sunucu Giriş Ekranı</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.authed?
{P.content?
{>{W.moddir}/motd.txt:{P.content}}
Fisier Salvat !
{h.location:sunucugirisekrani.w?basari=kaydedildi}
:
<form action="sunucugirisekrani.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/{motd.txt}}</textarea>
