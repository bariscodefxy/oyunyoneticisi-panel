...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Yasaklı Tuşlar » {<administrator/bilgiler/baslik.w}</title>
...
<div class="notification information png_bg">
				<div>
					Sunucunuzdaki Yasaklı Tuşları Düzenleyebilirsiniz. 
				</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Yasaklı Tuşlar</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.authed?
{P.content?
{>{W.moddir}/addons/amxmodx/configs/client_autoexec.ini:{P.content}}
Fisier Salvat !
{h.location:yasaklituslar.w?basari=kaydedildi}
:
<form action="yasaklituslar.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/amxmodx/configs/{client_autoexec.ini}}</textarea>
