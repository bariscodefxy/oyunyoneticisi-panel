...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Otomatik Say Reklamı » {<administrator/bilgiler/baslik.w}</title>
...
<div class="notification information png_bg">
				<div>
					Sunucunuzdaki Say Reklamlarını Düzenleyebilirsiniz.</div>
			</div>
						...
						<table width="1030">
							...
							<thead>
								<tr>
								   <th width="184">Otomatik Say Reklamı</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
								   <th>&nbsp;</th>
						...
						{v.authed?
{P.content?
{>{W.moddir}/addons/amxmodx/configs/messages.ini:{P.content}}
Fisier Salvat !
{h.location:otomatiksayreklami.w?basari=kaydedildi}
:
<form action="otomatiksayreklami.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/addons/amxmodx/configs/{messages.ini}}</textarea>
