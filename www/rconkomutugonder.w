...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Rcon Komutu Gönder » {<administrator/bilgiler/baslik.w}</title>
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="rconkomutugonder.w">Rcon Komutu Gönder</a></li>						
...
{P.command? <div class="notification success png_bg">
				...
				<div>
					"{P.command}" Komutu Başarıyla Sunucuya Gönderildi.
				</div>
			</div> 
{@@rcon:{P.command}} }
...
<div class="notification information png_bg">
				<div>
					Sunucunuza Rcon Komutu Gönderebilirsiniz.</div>
			</div>
			

						
<form action="rconkomutugonder.w" method="post" name="rconform">
						
						<table width="1030">
						<img src="administrator/tasarim/images/rconicon.png">	
							...
							<tbody>
								<tr>
									...
									<b>Rcon Komutu:</b></td>
									<td>
									<input class="text-input medium-input" type="text" name="command" size="20">
</td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									...
									&nbsp;</td>
									<td>
									<input class=button type="submit" value="Gönder"></td>
									<td>&nbsp;<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
