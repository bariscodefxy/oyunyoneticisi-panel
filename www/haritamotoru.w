...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Harita Motoru » {<administrator/bilgiler/baslik.w}</title>
			...
			<a href="#"><img id="logo" src="administrator/tasarim/images/logo.png" alt="Simpla Admin logo" /></a><ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a class=current href="haritamotoru.w">Harita Motoru</a></li>
...
<div class="notification information png_bg">
				<div>
					Sunucunuzda Açılacak Haritaları Düzenleyebilirsiniz. 
				</div>
			</div>
						...
						{v.authed?
{P.content?
{>{W.moddir}/mapcycle.txt:{P.content}}
Fisier Salvat !
{h.location:haritamotoru.w?basari=kaydedildi}
:
<form action="haritamotoru.w" method=post name=fedit>
<input type=hidden name=filename value="{P.filename}">
<p align="center">
<textarea name="content" rows=23 cols=70>{<<{W.moddir}/{mapcycle.txt}}</textarea>
