...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Eklentiler » {<administrator/bilgiler/baslik.w}</title>
...
{{G.basari=eklentidurumudegistirildi}?
<div class="notification success png_bg">
				...
				<div>
					Eklenti Durumu Başarıyla Değiştirildi.
				</div>
			</div>
}
...
<div class="notification attention png_bg">
				<div>
					Sunucunuzdaki Eklentilerle Yaptığınız Değişiklikler Harita Değişiminden Sonra Aktif Olacaktır.</div>
			</div>
			
<div class="notification information png_bg">
				<div>
					Sunucunuzdaki Eklentileri Yönetebilirsiniz.</div>
			</div>
			

												
						{<administrator/ekstra/eklentiler.w}	
